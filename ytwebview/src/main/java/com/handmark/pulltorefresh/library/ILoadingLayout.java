...
public interface ILoadingLayout {
     ...
     * released. This is the same as calling <code>setReleaseLabel(releaseLabel, Mode.BOTH)</code>
     *
     ...
     * displayed. Please see {@link android.widget.TextView#setTypeface(Typeface)
